...
class InventoryItem(models.Model):
    ...
    unit = models.CharField(
        "Unidade", max_length=5, choices=Unit.choices, default=Unit.UNIT
    )
    ...
    last_purchase_cost = models.DecimalField(
        "Último Custo de Compra", max_digits=12, decimal_places=2, null=True, blank=True
    )
    ...
    lead_time_days = models.PositiveIntegerField(
        "Lead Time (dias)", null=True, blank=True
    )

    # Imagem
    image = models.ImageField(
        "Imagem", upload_to="inventory/items/", blank=True, null=True
    )
    image_url = models.TextField(
        "URL da Imagem", blank=True, null=True, help_text="URL ou Data URI da imagem"
    )
...
class InventoryMovement(models.Model):
    ...
    quantity_after = models.DecimalField(
        "Quantidade Depois", max_digits=12, decimal_places=2
    )

    unit_cost = models.DecimalField(
        "Custo Unitário", max_digits=12, decimal_places=2, null=True, blank=True
    )
...
class InventoryCount(models.Model):
    ...
    categories = models.ManyToManyField(
        InventoryCategory, blank=True, related_name="counts", verbose_name="Categorias"
    )
...
class InventoryCountItem(models.Model):
    ...
    expected_quantity = models.DecimalField(
        "Quantidade Esperada", max_digits=12, decimal_places=2
    )
    counted_quantity = models.DecimalField(
        "Quantidade Contada", max_digits=12, decimal_places=2, null=True, blank=True
    )
