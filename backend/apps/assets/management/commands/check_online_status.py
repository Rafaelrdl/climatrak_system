...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            self.style.HTTP_INFO("🔍 Executando: check_sensors_online_status")
        )
        ...
        self.stdout.write(
            f"  Sensores verificados: {result_sensors['total_sensors_checked']}"
        )
        ...
        self.stdout.write(
            f"  Devices verificados: {result_devices['total_devices_checked']}"
        )
