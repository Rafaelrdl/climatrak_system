...
class EmailBackend(ModelBackend):
    ...
    def authenticate(self, request, username=None, password=None, **kwargs):
        ...
        logger.info(f'🔐 EmailBackend.authenticate - Schema: {current_schema}, Email: {username}')
        ...
        with schema_context(current_schema):
            ...
            logger.info(f'🔐 EmailBackend - Total users in schema {current_schema}: {total_users}')
            ...
            logger.info(f'🔐 EmailBackend - Password OK: {password_ok}, Can Auth: {can_auth}')
