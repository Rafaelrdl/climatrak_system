...
Testes de integraçăo para os endpoints da API de Ledger:
...
NOTA: Estes testes usam TenantTestCase com chamadas diretas ŕs views via
...
class BaseLedgerAPITestCase(TenantTestCase):
    ...
    def setUp(self):
        ...
        self.tx_labor = CostTransaction.objects.create(
            ...
            description="Măo de obra manutençăo preventiva",
...
class CostTransactionAPITests(BaseLedgerAPITestCase):
    ...
    def test_list_transactions(self):
        """GET /api/finance/transactions/ deve listar transaçőes."""
    ...
    def test_get_transaction_detail(self):
        ...
        self.assertEqual(response.data["transaction_type_display"], "Măo de Obra")
    ...
    def test_create_transaction_manual(self):
        """POST /api/finance/transactions/ deve criar transaçăo manual."""
        data = {
            "transaction_type": "other",
            "category": "other",
            "amount": "150.00",
            "occurred_at": timezone.now().isoformat(),
            "description": "Transaçăo manual de teste",
    ...
    def test_update_unlocked_transaction(self):
        """PATCH deve funcionar em transaçăo năo bloqueada."""
        data = {"description": "Descriçăo atualizada"}
        ...
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.data["description"], "Descriçăo atualizada")

    def test_update_locked_transaction_fails(self):
        """PATCH deve falhar em transaçăo bloqueada."""
        # Bloquear a transaçăo
        self.tx_labor.lock(self.user)

        data = {"description": "Tentativa de atualizaçăo"}
    ...
    def test_delete_unlocked_transaction(self):
        """DELETE deve funcionar em transaçăo năo bloqueada."""
    ...
    def test_summary_endpoint(self):
        """GET /api/finance/transactions/summary/ deve retornar agregaçőes."""
...
class LedgerAdjustmentAPITests(BaseLedgerAPITestCase):
    ...
    def test_create_adjustment_for_transaction(self):
        """POST /api/finance/adjustments/ deve criar ajuste para transaçăo existente."""
        data = {
            "original_transaction": str(self.tx_labor.id),
            "adjustment_type": "correction",
            "reason": "Correçăo de valor lançado incorretamente",
...
class LedgerModelTests(TenantTestCase):
    ...
    def test_transaction_idempotency_key_unique(self):
        ...
        CostTransaction.objects.create(
            ...
            description="Primeira transaçăo",
            cost_center=self.cost_center,
            created_by=self.user,
        )
        ...
        with self.assertRaises(ValidationError):
            CostTransaction.objects.create(
                ...
                occurred_at=timezone.now(),
                description="Segunda transaçăo duplicada",
                cost_center=self.cost_center,
                created_by=self.user,
            )

    def test_transaction_lock_prevents_edit(self):
        """Transaçăo bloqueada năo pode ter campos protegidos alterados."""
        ...
        # Tentar alterar campo protegido (amount) deve levantar exceçăo
    ...
    def test_adjustment_creates_transaction(self):
        ...
        serializer = LedgerAdjustmentCreateSerializer(
            data={
                ...
                "adjustment_type": "correction",
                "reason": "Correçăo de valor teste",
                "adjustment_amount": "-100.00",
            },
        ...
        # Deve ter criado transaçăo de ajuste
