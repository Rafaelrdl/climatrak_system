...
from apps.finance.cost_engine import CostEngineService, CostEngineError
...
class CostEngineProcessingTests(CostEngineTestCase):
    ...
    def test_process_creates_labor_transaction(self):
        ...
        self.assertEqual(labor_tx.transaction_type, CostTransaction.TransactionType.LABOR)
    ...
    def test_process_creates_parts_transaction(self):
        ...
        self.assertEqual(parts_tx.transaction_type, CostTransaction.TransactionType.PARTS)
    ...
    def test_process_creates_third_party_transaction(self):
        ...
        self.assertEqual(tp_tx.transaction_type, CostTransaction.TransactionType.THIRD_PARTY)
...
class CostEngineCategoryMappingTests(CostEngineTestCase):
    ...
    def test_category_mapping_corrective(self):
        ...
        tx = CostTransaction.objects.filter(
            idempotency_key=f"wo:{wo_id}:labor"
        ).first()
