...
class RateCardAdmin(admin.ModelAdmin):
    list_display = ['role', 'role_code', 'cost_per_hour', 'currency', 'effective_from', 'effective_to', 'is_active']
    ...
    fieldsets = (
        (None, {
            'fields': ('id', 'role', 'role_code', 'description')
        }),
        ('Custo', {
            'fields': ('cost_per_hour', 'currency')
        }),
        ('Vigência', {
...
class BudgetPlanAdmin(admin.ModelAdmin):
    list_display = ['code', 'name', 'year', 'status', 'total_planned', 'currency', 'created_at']
    ...
    fieldsets = (
        ...
        ('Valores', {
            'fields': ('total_planned', 'currency', 'status')
        }),
        ('Auditoria', {
            'fields': ('created_by', 'created_at', 'updated_at'),
            'classes': ('collapse',)
...
class BudgetEnvelopeAdmin(admin.ModelAdmin):
    list_display = ['name', 'budget_plan', 'cost_center', 'category', 'amount', 'is_active']
