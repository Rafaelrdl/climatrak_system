...
class RuleAdmin(BaseAdmin):
    ...
    fieldsets = (
        ...
        ("Equipamento", {"fields": ("equipment",)}),
        ("Ações", {"fields": ("actions",)}),
...
class AlertAdmin(BaseAdmin):
    ...
    fieldsets = (
        ("Alerta", {"fields": ("rule", "message", "severity")}),
        (
            "Dados",
            {"fields": ("asset_tag", "parameter_key", "parameter_value", "threshold")},
        ),
        ("Estado", {"fields": ("triggered_at",)}),
        (
            "Reconhecimento",
            {"fields": ("acknowledged", "acknowledged_at", "acknowledged_by")},
        ),
        ("Resolução", {"fields": ("resolved", "resolved_at", "resolved_by")}),
        ("Notas", {"fields": ("notes",)}),
    )
...
class NotificationPreferenceAdmin(BaseAdmin):
    ...
    fieldsets = (
        ...
        ("Contatos", {"fields": ("phone_number", "whatsapp_number")}),
        (
            "Informações do Sistema",
