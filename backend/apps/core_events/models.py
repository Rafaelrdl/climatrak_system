...
class OutboxEvent(models.Model):
    ...
    aggregate_id = models.UUIDField(
        verbose_name="ID do Agregado", help_text="ID do agregado que originou o evento"
    )
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=["event_name", "status"], name="outbox_event_name_idx"),
            # Busca por agregado
            models.Index(
    ...
    def mark_failed(self, error_message: str):
        ...
        self.save(
            update_fields=["status", "last_error", "last_attempt_at", "updated_at"]
        )
    ...
    def increment_attempt(self, error_message: str = None):
        ...
        self.save(
            update_fields=["attempts", "last_attempt_at", "last_error", "updated_at"]
        )
        return True
