...
class ChecklistTemplateListSerializer(serializers.ModelSerializer):
    ...
    category_color = serializers.CharField(
        source="category.color", read_only=True, allow_null=True
    )
...
class RequestListSerializer(serializers.ModelSerializer):
    ...
    asset_name = serializers.CharField(
        source="asset.name", read_only=True, allow_null=True
    )
...
class MaintenancePlanSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ["id", "work_orders_generated", "created_at", "updated_at"]
...
class ProcedureUpdateSerializer(serializers.ModelSerializer):
    ...
    version_changes = serializers.CharField(
...
class TimeEntrySerializer(serializers.ModelSerializer):
    ...
    technician_name = serializers.CharField(
        source="technician.get_full_name", read_only=True, allow_null=True
    )
...
class PartUsageSerializer(serializers.ModelSerializer):
    ...
    inventory_item_code = serializers.CharField(
        source="inventory_item.code", read_only=True, allow_null=True
    )
    total_cost = serializers.DecimalField(
        max_digits=14, decimal_places=2, read_only=True
    )
    ...
    def validate(self, data):
        ...
        work_order = data.get("work_order") or (
            self.instance.work_order if self.instance else None
        )
...
class WorkOrderCostSummarySerializer(serializers.Serializer):
    ...
    labor_total_cost = serializers.DecimalField(
    ...
    parts_total_cost = serializers.DecimalField(
        max_digits=14, decimal_places=2, allow_null=True
    )
