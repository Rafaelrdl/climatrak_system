...
class ChecklistCategory(models.Model):
    ...
    name = models.CharField(
        max_length=100, verbose_name="Nome", help_text="Nome da categoria"
    )
    description = models.TextField(
        blank=True, verbose_name="Descrição", help_text="Descrição da categoria"
    )
...
class ChecklistTemplate(models.Model):
    ...
    name = models.CharField(
        max_length=200, verbose_name="Nome", help_text="Nome descritivo do template"
    )
    description = models.TextField(
        blank=True,
    ...
    version = models.PositiveIntegerField(
        default=1, verbose_name="Versão", help_text="Versão do template"
    )
...
class Request(models.Model):
    ...
    status_history = models.JSONField(default=list, verbose_name="Histórico de Status")
    ...
    def save(self, *args, **kwargs):
        ...
        if not self.number:
            ...
            last_req = (
                Request.objects.filter(number__startswith=prefix)
                .order_by("-number")
                .first()
            )
...
class MaintenancePlan(models.Model):
    ...
    work_orders_generated = models.PositiveIntegerField(
        default=0, verbose_name="OS Geradas"
    )
...
class Procedure(models.Model):
    ...
    title = models.CharField(
        max_length=200, verbose_name="Título", help_text="Título do procedimento"
    )
    description = models.TextField(
        blank=True,
        verbose_name="Descrição",
    ...
    version = models.PositiveIntegerField(
        default=1, verbose_name="Versão", help_text="Número da versão atual"
    )
...
class PartUsage(models.Model):
    ...
    def __str__(self):
        name = self.part_name or (
            self.inventory_item.name if self.inventory_item else "Peça"
        )
...
class ExternalCost(models.Model):
    ...
    # Descrição
    description = models.TextField(
        verbose_name="Descrição", help_text="Descrição do serviço/custo"
    )
    ...
    invoice_date = models.DateField(null=True, blank=True, verbose_name="Data da NF")
