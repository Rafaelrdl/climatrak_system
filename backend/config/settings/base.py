...
# Rate limiting para evitar 429 (especialmente em free tiers)
LLM_RATE_LIMIT_DELAY = float(os.getenv("LLM_RATE_LIMIT_DELAY", "3.0"))  # Delay entre requisições (segundos)
LLM_RATE_LIMIT_BACKOFF = float(os.getenv("LLM_RATE_LIMIT_BACKOFF", "15.0"))  # Backoff após 429 (segundos)
