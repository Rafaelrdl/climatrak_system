  ...
  async update(
    ...
    if (offline) {
      await syncQueueStorage.addToQueue({
        ...
        action: 'update',
        method: 'PATCH',
        endpoint: `/api/cmms/work-orders/${id}/`,
        payload: data as unknown as Record<string, unknown>,
  ...
  async uploadPhoto(
    ...
    if (offline) {
      await syncQueueStorage.addToQueue({
        ...
        action: 'create',
        method: 'POST',
        endpoint: `/api/cmms/work-orders/${workOrderId}/photos/`,
  ...
  async addTimeEntry(
    ...
    if (offline) {
      await syncQueueStorage.addToQueue({
        ...
        action: 'create',
        method: 'POST',
        endpoint: `/api/cmms/work-orders/${workOrderId}/time-entries/`,
  ...
  async saveChecklistResponses(
    ...
    if (offline) {
      await syncQueueStorage.addToQueue({
        ...
        action: 'update',
        method: 'PATCH',
        endpoint: `/api/cmms/work-orders/${workOrderId}/`,
        payload: { responses },
